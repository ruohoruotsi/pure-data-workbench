...
// function prototypes
//-----------------------------------------------------------------------------
void  mixture_parse ( t_mixture* object, t_symbol* selector, int items, t_atom* list );
...
void mixture_parse( t_mixture* object, t_symbol* selector, int items, t_atom* list )
{
    ...
    // if the first message is a symbol shows up as the selector
    if( selector )
    {
